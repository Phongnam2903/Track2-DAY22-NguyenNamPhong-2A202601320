...
PROMPT_V1_NAME = "nguyen-nam-phong-day22-rag-v1"   # ví dụ: "nguyen-rag-v1"
PROMPT_V2_NAME = "nguyen-nam-phong-day22-rag-v2"   # ví dụ: "nguyen-rag-v2"
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1 – trả lời ngắn gọn, chỉ dựa trên context",
        )   # client.push_prompt(PROMPT_V1_NAME, object=PROMPT_V1, description="V1 – ngắn gọn")
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 – giọng chuyên gia, câu trả lời có cấu trúc",
        )   # client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 – có cấu trúc")
